...
mixin SC_FOURS {
  static ShotCard SHOT_CARD_SC1_DB = ShotCard(
      ...
      "Four's",
      [
        HashMap.of({"SHOT": Shot.withCount("4", 10, SHOT_TYPE.four)}), //Shot Group
        HashMap.of({"SHOT": Shot.withCount("0", 170, SHOT_TYPE.db)})
      ],
      cardType: 0,
  ...
  static ShotCard SHOT_CARD_SC1_OUT = ShotCard(
      ...
      "Four's",
      [
        HashMap.of({"SHOT": Shot.withCount("4", 85, SHOT_TYPE.four)}), //Shot Group
  ...
  static ShotCard SHOT_CARD_SC2_OUT = ShotCard(
      ...
      "Four's",
      [
        HashMap.of({"SHOT": Shot.withCount("4", 90, SHOT_TYPE.four)}), //Shot Group
  ...
  static ShotCard SHOT_CARD_SC4_DB = ShotCard(
      ...
      "Four's",
      [
        HashMap.of({"SHOT": Shot.withCount("4", 50, SHOT_TYPE.four)}), //Shot Group

...
mixin SC_TWOS {
  static ShotCard SHOT_CARD_SC1_DB = ShotCard("SINGLES", "Two's", [
  ...
  static ShotCard SHOT_CARD_SC1_OUT = ShotCard("SINGLES", "Two's", [
  ...
  static ShotCard SHOT_CARD_SC2_DB = ShotCard("SINGLES", "Two's", [
  ...
  static ShotCard SHOT_CARD_SC2_OUT = ShotCard("SINGLES", "Two's", [
    HashMap.of({"SHOT": Shot.withCount("2", 100, SHOT_TYPE.singles)}), //Shot Group
    HashMap.of({"SHOT": Shot.withCount("1", 20, SHOT_TYPE.nb)}),
    HashMap.of({"SHOT": Shot.withCount("O", 60, SHOT_TYPE.wicket)})
  ]);

  static ShotCard SHOT_CARD_SC3_DB = ShotCard("SINGLES", "Two's", [
  ...
  static ShotCard SHOT_CARD_SC3_OUT = ShotCard("SINGLES", "Two's", [
    HashMap.of({"SHOT": Shot.withCount("2", 100, SHOT_TYPE.singles)}), //Shot Group
    HashMap.of({"SHOT": Shot.withCount("1", 30, SHOT_TYPE.nb)}),
    HashMap.of({"SHOT": Shot.withCount("O", 50, SHOT_TYPE.wicket)})
  ]);

  static ShotCard SHOT_CARD_SC4_DB = ShotCard("SINGLES", "Two's", [
  ...
  static ShotCard SHOT_CARD_SC4_OUT = ShotCard("SINGLES", "Two's", [
    HashMap.of({"SHOT": Shot.withCount("2", 100, SHOT_TYPE.singles)}), //Shot Group

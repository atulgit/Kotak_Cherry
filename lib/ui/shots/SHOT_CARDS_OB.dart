...
mixin SHOT_CARDS_OB {
  ...
  HashMap.of({"L1": SC_ONES.SHOT_CARD_SC1_DB, "L2": SC_ONES.SHOT_CARD_SC2_DB, "L3": SC_ONES.SHOT_CARD_SC3_DB});

  static final HashMap<String, ShotCard> _SHOT_CARDS_ONES_OUT =
  HashMap.of({"L1": SC_ONES.SHOT_CARD_SC1_OUT, "L2": SC_ONES.SHOT_CARD_SC2_OUT, "L3": SC_ONES.SHOT_CARD_SC3_OUT});

  static final HashMap<String, ShotCard> _SHOT_CARDS_TWOS_DB =
  HashMap.of({"L1": SC_TWOS.SHOT_CARD_SC1_DB, "L2": SC_TWOS.SHOT_CARD_SC2_DB, "L3": SC_TWOS.SHOT_CARD_SC3_DB});

  static final HashMap<String, ShotCard> _SHOT_CARDS_TWOS_OUT =
  HashMap.of({"L1": SC_TWOS.SHOT_CARD_SC1_OUT, "L2": SC_TWOS.SHOT_CARD_SC2_OUT, "L3": SC_TWOS.SHOT_CARD_SC3_OUT});

  static final HashMap<String, ShotCard> _SHOT_CARDS_THREE_DB =
  HashMap.of({"L1": SC_THREES.SHOT_CARD_SC1_DB, "L2": SC_THREES.SHOT_CARD_SC2_DB, "L3": SC_THREES.SHOT_CARD_SC3_DB});

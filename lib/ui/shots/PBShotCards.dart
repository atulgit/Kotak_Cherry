...
import 'package:kotak_cherry/ui/shots/Shot_Cards/SC_THREES.dart';
...
mixin PBShotCards {
  ...
  static ShotCard SHOT_CARD_2 = ShotCard("SINGLES", "Two's", [
    HashMap.of({"L1": Shot.withCount("2", 40, SHOT_TYPE.singles)}),
    HashMap.of({"L1": Shot.withCount("1", 10, SHOT_TYPE.wb)}),
    HashMap.of({"L1": Shot.withCount("0", 130, SHOT_TYPE.db)})
  ]);

  static ShotCard SHOT_CARD_3 = ShotCard("SINGLES", "Three's", [
    HashMap.of({"L1": Shot.withCount("3", 25, SHOT_TYPE.singles)}),

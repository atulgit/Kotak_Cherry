...
mixin PBShotCards {
  ...
  static ShotCard SHOT_CARD_1 = ShotCard("SINGLES", "Safe Singles", [
    HashMap.of({"L1": Shot.withCount("1", 24, SHOT_TYPE.singles)}),
    HashMap.of({"L1": Shot.withCount("2", 12, SHOT_TYPE.singles)})
  ]);

  // static ShotCard SHOT_CARD_1 = ShotCard("SINGLES", "Safe Singles", [
  //   HashMap.of({"L1": Shot.withCount("O", 24, SHOT_TYPE.tuWicket)}),
  //   HashMap.of({"L1": Shot.withCount("O", 12, SHOT_TYPE.tuWicket)})
  // ]);

  static ShotCard SHOT_CARD_2 = ShotCard("SINGLES", "Some More Singles", [
    HashMap.of({"L1": Shot.withCount("0", 6, SHOT_TYPE.db)}),
  ...
  static ShotCard SHOT_CARD_3 = ShotCard("SINGLES", "Desperate Singles", [
    HashMap.of({"L1": Shot.withCount("2", 12, SHOT_TYPE.singles)}),
    HashMap.of({"L1": Shot.withCount("3", 18, SHOT_TYPE.singles)}),
  ...
  static ShotCard SHOT_CARD_4 = ShotCard("SINGLES", "Relaxed Score", [
    ...
    HashMap.of({"L1": Shot.withCount("4", 6, SHOT_TYPE.four)}),
    HashMap.of({"L1": Shot.withCount("0", 6, SHOT_TYPE.nb)})
  ]);
  ...
  static ShotCard SHOT_CARD_6 = ShotCard("FOUR", "Four Boundary", [
    ...
    HashMap.of({"L1": Shot.withCount("4", 18, SHOT_TYPE.four)}), //CARD SLOT - L1/L2/L3
  ...
  static ShotCard SHOT_CARD_8 = ShotCard("SIX", "Six Boundary", [
    HashMap.of({"L1": Shot.withCount("0", 6, SHOT_TYPE.singles)}),
    HashMap.of({"L1": Shot.withCount("6", 24, SHOT_TYPE.six)}),
    HashMap.of({"L1": Shot.withCount("O", 6, SHOT_TYPE.tuWicket)})
  ]);
  ...
  //   HashMap.of({"L1": Shot.withCount("0", 3, SHOT_TYPE.db)}),
  //   HashMap.of({"L1": Shot.withCount("0", 3, SHOT_TYPE.wicket)})
  // ];
...
//TU-OUT -> Original Decision -> Out for OB, Original Decision -> NOT OUT for PB
}
